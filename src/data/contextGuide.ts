...
export const mediaRecommendations: MediaRecommendation[] = [
  ...
  },
  {
    ...
    kind: "press",
    title: "Exberliner / The Berliner",
    creator: "Berlin English-language local media",
    note: { es: "Radar local en inglés para cultura, comida, política urbana y eventos independientes de última hora.", en: "English-language local radar for culture, food, urban politics and last-minute independent events." },
    bestFor: { es: "Agenda independiente", en: "Independent agenda" },
    url: "https://www.the-berliner.com/",
    language: "EN",
  },
  {
    id: "resident-advisor-berlin",
    kind: "press",
    title: "Resident Advisor Berlin",
    creator: "Electronic music listings",
    note: { es: "La mejor pista para fiestas de día, open airs y patios en Kreuzberg/Neukölln; confirmar siempre ticket y puerta en la ficha del evento.", en: "The best lead for daytime parties, open airs and courtyards in Kreuzberg/Neukolln; always confirm ticket and door details on the event listing." },
    bestFor: { es: "Open airs y electrónica", en: "Open airs and electronic music" },
