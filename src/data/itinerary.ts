...
export const itinerary: ItineraryDay[] = [
  ...
  {
    date: "2026-06-13",
    label: { es: "Sábado 13 junio · Spree suave y ehrlich en Humboldthain", en: "Saturday 13 June · soft Spree and ehrlich at Humboldthain" },
    blocks: {
      morning: [
      ...
      afternoon: [
        item("d13-a1", "Friedrichshain/RAW queda en versión corta: paseo por RAW-Gelaende y Urban Spree solo si vais frescos. Si la fiesta empieza a las 20:00 para vosotros, aquí no se exprime nada.", "Friedrichshain/RAW becomes the short version: walk RAW-Gelaende and Urban Spree only if you are fresh. If the party starts around 20:00 for you, do not squeeze this block.", { placeId: "raw-gelaende", duration: "45-90 min", routeFromPlaceId: "holzmarkt-25", flags: ["tired"] }),
        item("d13-a2", "Compra logística antes de subir al norte: agua, snack y quizá algo vegano en REWE voll pflanzlich. Mejor llegar a Humboldthain alimentados.", "Logistics before heading north: water, snack and maybe vegan supplies at REWE voll pflanzlich. Better to arrive at Humboldthain fed.", { placeId: "rewe-voll-pflanzlich", duration: "15-30 min" }),
      ],
      dinner: [
        item("d13-d1", "Cena temprana y simple antes de Humboldthain. La fiesta tiene comida de 18:00-20:00 por donación, pero no dependáis de eso como única cena.", "Early, simple dinner before Humboldthain. The party has donation food from 18:00-20:00, but do not depend on that as your only dinner.", { placeId: "1990-vegan-living" }),
      ],
      evening: [
        item("d13-e1", "Objetivo realista: llegar a Humboldthain sobre las 20:00. ehrlich va de 13:00 a 08:00, pero entrar por la tarde-noche os deja mucha fiesta sin quemar todo el sábado.", "Realistic target: reach Humboldthain around 20:00. ehrlich runs 13:00-08:00, but entering in the evening leaves plenty of party without burning the whole Saturday.", { eventId: "ehrlich-humboldthain-2026-06-13", flags: ["booking"] }),
      ],
      night: [
        item("d13-n1", "Plan elegido: ehrlich en Humboldthain, outdoor + indoor, tres floors y trance/techno rápido hasta las 08:00. Si entráis a las 20:00, decidid una hora límite antes de llegar.", "Chosen plan: ehrlich at Humboldthain, outdoor + indoor, three floors and fast trance/techno until 08:00. If entering around 20:00, decide an exit limit before arriving.", { eventId: "ehrlich-humboldthain-2026-06-13", flags: ["booking"] }),
      ],
      alternatives: [
        item("d13-x1", "Para que Humboldthain funcione, recortad lo largo antes: RAW/Urban Spree en versión paseo corto, sin museo extra ni rastro añadido.", "For Humboldthain to work, trim the long pre-party bits: RAW/Urban Spree as a short walk, no extra museum and no added flea market.", { flags: ["tired"] }),
        item("d13-x2", "Segunda opción dura: Glitch Berlin en RSO, 22:00-lunes 06:00. Más industrial y lejos que Humbi; elegidlo si os llama más el cartel.", "Hard second option: Glitch Berlin at RSO, 22:00-Monday 06:00. More industrial and farther than Humbi; choose it if the lineup pulls you more.", { eventId: "glitch-berlin-rso-2026-06-13", flags: ["booking"] }),
        item("d13-x3", "Segunda opción completa y más amable: Else x Mano Le Tough, 14:00-08:00. Mejor si queréis terraza, Spree y house/techno menos hard.", "Full, softer second option: Else x Mano Le Tough, 14:00-08:00. Better if you want terrace, Spree and less-hard house/techno.", { eventId: "else-mano-le-tough-maeve-2026-06-13", flags: ["booking", "cash_card"] }),
        item("d13-x4", "Segunda opción luminosa: Toy Tonics en AEDEN, 14:00-08:00, house/disco. Tiene sentido si queréis algo más colorido que Humbi/RSO.", "Bright second option: Toy Tonics at AEDEN, 14:00-08:00, house/disco. Makes sense if you want something more colourful than Humbi/RSO.", { eventId: "toy-tonics-aeden-2026-06-13", flags: ["booking"] }),
        item("d13-x5", "Segunda opción Spree fácil: Watergate Open Air en SAGE, 15:00-03:00. Menos maratón y menos puerta dura.", "Easy Spree second option: Watergate Open Air at SAGE, 15:00-03:00. Less of a marathon and less of a door gamble.", { eventId: "watergate-open-air-sage-2026-06-13" }),
        item("d13-x6", "Segunda opción de escena: STAUB XL en about blank, 12:00-10:00, jardín y techno/experimental. Solo si os apetece algo más serio y menos obvio.", "Scene second option: STAUB XL at about blank, 12:00-10:00, garden and techno/experimental. Only if you want something more serious and less obvious.", { eventId: "staub-xl-about-blank-2026-06-13", flags: ["booking"] }),
        item("d13-x7", "Sisyphos queda como radar: ahora mismo la web oficial muestra evento del 19 al 22, fuera del viaje; si aparece algo nuevo en fechas, entra en la comparativa.", "Keep Sisyphos as a radar: right now the official site shows a 19-22 June event, outside the trip; if something new appears on your dates, it enters the comparison.", { placeId: "sisyphos", flags: ["booking"] }),
      ],
    },
  },
  {
    ...
    blocks: {
      ...
      night: [
        item("d14-n1", "Si queréis after/rave diurno y os queda cuerpo, OHNE en 90mil va de 08:00 a 20:00 con RSVP/donación. Solo con entrada clara y respeto al espacio.", "If you want a daytime after/rave and still have energy, OHNE at 90mil runs 08:00-20:00 with RSVP/donation. Only with clear entry and respect for the space.", { eventId: "ohne-90mil-2026-06-14" }),
      ...
      alternatives: [
        ...
        item("d14-x8", "Si os apetece improvisar algo más subcultural que turístico, revisad Stressfaktor/Squat!net por fecha: punk, Küfa, charla, beneficio o fiesta pequeña. Solo eventos públicos claros.", "If you want to improvise something more subcultural than touristy, check Stressfaktor/Squat!net by date: punk, Kuefa, talk, benefit or small party. Clearly public events only.", { placeId: "stressfaktor-calendar" }),
        ...
        item("d14-x10", "Si salís pronto de Humboldthain o dormís unas horas y queréis otra cosa de día, OHNE/90mil es la opción más rara; si no, Mauerpark/YAAM gana por recuperación.", "If you leave Humboldthain early or sleep a few hours and want another daytime thing, OHNE/90mil is the oddest option; otherwise Mauerpark/YAAM wins for recovery.", { eventId: "ohne-90mil-2026-06-14", flags: ["tired"] }),
      ],
    },
  },
  {
