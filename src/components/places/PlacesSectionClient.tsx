...
export function PlacesSectionClient({ title, categories, showMarketFilters = false }: { title: string; categories: PlaceCategory[]; showMarketFilters?: boolean }) {
  ...
  return (
    <section className="space-y-4">
      ...
      <PlaceFilters filters={filters} setFilters={setFilters} categories={categories} neighbourhoods={neighbourhoods} locale={locale} showMarketFilters={showMarketFilters} />
